...
# Common settings
t_min, t_max = -15, 30
th_min, th_max = 1, 1000000 # Log scale for thermal age
...
ax1.set_ylabel("Arrhenius Thermal Age (Years @ 10 °C Reference, log scale)", fontsize=11, fontweight="bold")
ax1.grid(True, which="both", linestyle=":", alpha=0.5)
ax1.legend(frameon=True, facecolor="white", edgecolor="#cccccc", fontsize=9.5, loc="lower right")
...
ax2.set_ylim(1, 1000000) # Reaches much higher thermal ages!
...
ax2.legend(frameon=True, facecolor="white", edgecolor="#cccccc", fontsize=9.5, loc="lower right")

plt.tight_layout()
out_plot = os.path.join(output_dir, "Figure_Integrated_Temp_vs_Thermal_Age_Collagen_vs_Controls.png")
plt.savefig(out_plot, dpi=300)
print(f"Saved publication figure to: {out_plot}")
